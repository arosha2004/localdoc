...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(errorMsg);
      setShowModal(true); // Trigger custom React popup completely safe from HMR bugs
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="auth-page">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm transform transition-all text-center">
            ...
            <button 
              ...
              className="w-full bg-slate-900 text-white font-bold py-3 px-4 rounded-xl hover:bg-black transition-colors"
            >
              Try Again
            </button>
          </div>
